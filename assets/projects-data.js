window.PROJECTS_DATA = [
  {
    "id": "llms-agents-code",
    "title": "LLMs, Agents, and Hardware-Aware Parallel Code",
    "description": "This is a long-running thread around code as a computational object: understanding it, parallelizing it, translating it, modeling it, and eventually letting agents reason about it. The project starts before the current LLM wave, with source-to-source compilation and automatic OpenMP work, and later expands into transformers, domain-specific code models, performance reasoning, accelerator targets, and autonomous coding agents.",
    "bullets": [
      "Automatic parallelization and source-to-source compilation",
      "LLMs for OpenMP, MPI, HPC code, and code translation",
      "Reasoning about floating-point load, runtime behavior, and hardware targets"
    ],
    "papers": [
      {
        "id": "paracodex",
        ...
        "venue": "arXiv",
        "summary": "An autonomous workflow for reliable parallel code generation and translation.",
        ...
        "paperUrl": "https://arxiv.org/abs/2601.04327",
        "image": "assets/papers/systems-paracodex.png",
        "caption": "An autonomous workflow for reliable parallel code generation and translation.",
        "alt": "ParaCodex: A Profiling-Guided Autonomous Coding Agent for Reliable Parallel Code Generation and Translation preview image"
      },
      {
        "id": "unipar",
        "year": 2025,
        ...
        "venue": "HPEC",
        "summary": "LLM-based translation across serial, OpenMP, CUDA, and related HPC settings.",
        ...
        "paperUrl": "https://arxiv.org/abs/2509.12136",
        "image": "assets/papers/systems-unipar.png",
        "caption": "LLM-based translation across serial, OpenMP, CUDA, and related HPC settings.",
        "alt": "UniPar: A Unified LLM-Based Framework for Parallel and Accelerated Code Translation in HPC preview image"
      },
      {
        "id": "llm-performance",
        "year": 2025,
        ...
        "venue": "HPDC",
        "summary": "LLMs reason about roofline-style performance, not just code generation.",
        ...
        "paperUrl": "https://arxiv.org/abs/2505.03988",
        "image": "assets/papers/systems-performance.png",
        "caption": "LLMs reason about roofline-style performance, not just code generation.",
        "alt": "Can Large Language Models Predict Parallel Code Performance? preview image"
      },
      {
        "id": "pragformer",
        "year": 2025,
        ...
        "summary": "Transformer-based classification of OpenMP directives and parallel code intent.",
        ...
        "paperUrl": "https://link.springer.com/article/10.1007/s10766-024-00778-9",
        "image": "assets/papers/generated/pragformer.jpg",
        "caption": "Transformer-based classification of OpenMP directives and parallel code intent.",
        "alt": "PragFormer: Data-Driven Parallel Source Code Classification with Transformers preview image"
      },
      {
        "id": "landscape-hpc-llms",
        "year": 2024,
        ...
        "venue": "arXiv",
        "summary": "A field-level framing of how LLMs meet HPC research problems.",
        ...
        "paperUrl": "https://arxiv.org/abs/2402.02018",
        "image": "assets/papers/generated/landscape-hpc-llms.jpg",
        "caption": "A field-level framing of how LLMs meet HPC research problems.",
        "alt": "The Landscape and Challenges of HPC Research and LLMs preview image"
      },
      {
        "id": "monocoder",
        "year": 2024,
        ...
        "venue": "HPEC",
        "summary": "A compact domain-specific language model trained for HPC codes and tasks.",
        ...
        "paperUrl": "https://arxiv.org/abs/2312.13322",
        "image": "assets/papers/generated/monocoder.jpg",
        "caption": "A compact domain-specific language model trained for HPC codes and tasks.",
        "alt": "MonoCoder: Domain-Specific Code Language Model for HPC Codes and Tasks preview image"
      },
      {
        "id": "ompgpt",
        "year": 2024,
        ...
        "venue": "Euro-Par",
        "summary": "OpenMP treated as a dedicated language-modeling target.",
        ...
        "paperUrl": "https://arxiv.org/abs/2401.16445",
        "image": "assets/papers/systems-ompgpt.png",
        "caption": "OpenMP treated as a dedicated language-modeling target.",
        "alt": "OMPGPT: A Generative Pre-trained Transformer Model for OpenMP preview image"
      },
      {
        "id": "mpirigen",
        "year": 2024,
        ...
        "venue": "AI for Systems Workshop",
        "summary": "Domain-specific generation of MPI code and distributed parallel patterns.",
        ...
        "paperUrl": "https://arxiv.org/abs/2402.09126",
        "image": "assets/papers/generated/mpirigen.jpg",
        "caption": "Domain-specific generation of MPI code and distributed parallel patterns.",
        "alt": "MPIrigen: MPI Code Generation through Domain-Specific Language Models preview image"
      },
      {
        "id": "ompar",
        "year": 2024,
        ...
        "venue": "NeurIPS ML for Systems Workshop",
        "summary": "AI-driven source-to-source compilation for OpenMP parallelization.",
        ...
        "paperUrl": "https://arxiv.org/abs/2409.14771",
        "image": "assets/papers/generated/ompar.jpg",
        "caption": "AI-driven source-to-source compilation for OpenMP parallelization.",
        "alt": "OMPar: Automatic Parallelization with AI-Driven Source-to-Source Compilation preview image"
      },
      {
        "id": "scope",
        "year": 2023,
        ...
        "venue": "arXiv",
        "summary": "Early adaptation of LLMs to the structure of HPC code.",
        ...
        "paperUrl": "https://arxiv.org/abs/2308.09440",
        "image": "assets/papers/generated/scope.jpg",
        "caption": "Early adaptation of LLMs to the structure of HPC code.",
        "alt": "Scope is all you need: Transforming LLMs for HPC Code preview image"
      },
      {
        "id": "quantifying-openmp",
        "year": 2023,
        ...
        "venue": "HPEC",
        "summary": "A quantitative lens on how parallel code is actually written and adopted.",
        ...
        "paperUrl": "https://arxiv.org/abs/2308.08002",
        "image": "assets/papers/generated/quantifying-openmp.jpg",
        "caption": "A quantitative lens on how parallel code is actually written and adopted.",
        "alt": "Quantifying OpenMP: Statistical Insights into Usage and Adoption preview image"
      },
      {
        "id": "advising-openmp",
        "year": 2023,
        ...
        "venue": "IWOMP",
        "summary": "Graph-based transformer methods for OpenMP advice and pragma recommendation.",
        ...
        "paperUrl": "https://arxiv.org/abs/2305.11999",
        "image": "assets/papers/generated/advising-openmp.jpg",
        "caption": "Graph-based transformer methods for OpenMP advice and pragma recommendation.",
        "alt": "Advising OpenMP Parallelization via a Graph-Based Approach with Transformers preview image"
      },
      {
        "id": "mpirical",
        "year": 2023,
        ...
        "venue": "SC Workshops",
        "summary": "Transformer-based assistance for MPI parallelization and domain decomposition.",
        ...
        "paperUrl": "https://arxiv.org/abs/2305.09438",
        "image": "assets/papers/generated/mpirical.jpg",
        "caption": "Transformer-based assistance for MPI parallelization and domain decomposition.",
        "alt": "MPI-RICAL: Data-Driven MPI Distributed Parallelism Assistance with Transformers preview image"
      },
      {
        "id": "learning-to-parallelize",
        "year": 2023,
        ...
        "venue": "PPoPP",
        "summary": "Learning the structure of shared-memory parallelization with transformers.",
        ...
        "paperUrl": "https://arxiv.org/abs/2204.12835",
        "image": "assets/papers/generated/learning-to-parallelize.jpg",
        "caption": "Learning the structure of shared-memory parallelization with transformers.",
        "alt": "Learning to Parallelize in a Shared-Memory Environment with Transformers preview image"
      },
      {
        "id": "compar",
        "year": 2020,
        ...
        "venue": "IWOMP",
        "summary": "An earlier compiler-centered root of the automatic parallelization program.",
        ...
        "paperUrl": "https://arxiv.org/abs/2005.13304",
        "image": "assets/papers/found-compar.png",
        "caption": "An earlier compiler-centered root of the automatic parallelization program.",
        "alt": "ComPar: Optimized Multi-Compiler for Automatic OpenMP S2S Parallelization preview image"
      }
    ]
  },
  {
    "id": "textures-microstructure",
    "title": "Computational Vision for Scientific Textures and Microstructure",
    "description": "This thread centers on computer vision for scientific textures, microstructure, and morphology. The recurring idea is that in many scientific images the signal is not a familiar object but a texture, a pattern, or a physically meaningful spatial structure.",
    "bullets": [
      "Quantitative metallography and microstructure analysis",
      "Texture-sensitive segmentation and representation learning",
      "Pattern-based visual reasoning beyond standard semantic objects"
    ],
    "papers": [
      {
        "id": "texturesam",
        ...
        "venue": "arXiv",
        "summary": "Texture-aware segmentation with a foundation-model lens.",
        ...
        "paperUrl": "https://arxiv.org/abs/2505.16540",
        "image": "assets/papers/science-texturesam.jpg",
        "caption": "Texture-aware segmentation with a foundation-model lens.",
        "alt": "TextureSAM: Towards a Texture Aware Foundation Model for Segmentation preview image"
      },
      {
        "id": "metallography",
        "year": 2022,
        ...
        "summary": "Quantitative vision for materials microstructure and metallography.",
        ...
        "paperUrl": "https://arxiv.org/abs/2104.11159",
        "image": "assets/papers/science-metallography.png",
        "caption": "Quantitative vision for materials microstructure and metallography.",
        "alt": "An End-to-End Computer Vision Methodology for Quantitative Metallography preview image"
      },
      {
        "id": "changechip",
        "year": 2021,
        ...
        "venue": "PAINE",
        "summary": "Unsupervised change detection for PCB defect inspection.",
        ...
        "paperUrl": "https://arxiv.org/abs/2109.05746",
        "image": "assets/papers/generated/changechip.jpg",
        "caption": "Unsupervised change detection for PCB defect inspection.",
        "alt": "ChangeChip: A Reference-Based Unsupervised Change Detection for PCB Defect Detection preview image"
      }
    ]
  },
  {
    "id": "experimental-physics",
    "title": "AI for Experimental Physics and Feedback-Driven Physical Processes",
    "description": "This project groups work where learning is tied to physical experiments or physically constrained processes: analyzing hydrodynamic instabilities, interpreting experimental physics imagery, and improving simulation-driven physical optimization through feedback.",
    "bullets": [
      "Computer vision for hydrodynamic instability experiments",
      "Explainable multi-view learning in experimental physics",
      "Simulation-in-the-loop optimization for physical systems"
    ],
    "papers": [
      {
        "id": "reactor-rl",
        ...
        "venue": "arXiv",
        "summary": "Reinforcement learning for constrained physical optimization in reactor design.",
        ...
        "paperUrl": "https://arxiv.org/abs/2403.14273",
        "image": "assets/papers/science-reactor.png",
        "caption": "Reinforcement learning for constrained physical optimization in reactor design.",
        "alt": "Reactor Optimization Benchmark by Reinforcement Learning preview image"
      },
      {
        "id": "clariphy",
        "year": 2024,
        "title": "CLARIPHY: Physics-Informed Image Deblurring with Transformers for Hydrodynamic Instability Analysis",
        "authors": [
          "Shai Stamler-Grossman",
          "Nadav Schneider",
          "Gershon Hanoch",
          "Gal Oren"
        ],
        "venue": "NeurIPS ML4PS Workshop",
        "summary": "Physics-informed deblurring for hydrodynamic instability experiments.",
        "abstract": "Recent advances in deep learning have greatly improved image deblurring for natural scenes. However, applying these methods to physical experiments, especially those involving rapid, complex dynamics like hydrodynamic instabilities, remains challenging. We propose CLARIPHY, a transformer-based approach built on Restormer and fine-tuned on a deblurring dataset derived from Rayleigh-Taylor instability simulations, with sharp and blurred image pairs designed to reflect real experimental conditions.",
        "paperUrl": "https://ml4physicalsciences.github.io/2024/files/NeurIPS_ML4PS_2024_19.pdf",
        "image": "assets/papers/generated/clariphy.jpg",
        "caption": "Physics-informed deblurring for hydrodynamic instability experiments.",
        "alt": "CLARIPHY: Physics-Informed Image Deblurring with Transformers for Hydrodynamic Instability Analysis preview image"
      },
      {
        "id": "multiview-physics",
        "year": 2023,
        "title": "Explainable Deep Multi-View Methodology for HEDP Foam Quality Assessment",
        "authors": [
          "Nadav Schneider",
          "Muriel Tzdaka",
          "Galit Sturm",
        ...
        "venue": "arXiv",
        "summary": "Explainable multi-view learning for experimental physics imagery.",
        ...
        "paperUrl": "https://arxiv.org/abs/2308.08206",
        "image": "assets/papers/science-physics-page1.png",
        "caption": "Explainable multi-view learning for experimental physics imagery.",
        "alt": "Explainable Deep Multi-View Methodology for HEDP Foam Quality Assessment preview image"
      },
      {
        "id": "hedp-foams",
        "year": 2022,
        ...
        "venue": "AI4S",
        "summary": "Learning-based quality assessment for HEDP foam experiments.",
        ...
        "paperUrl": "https://arxiv.org/abs/2208.07196",
        "image": "assets/papers/generated/hedp-foams.jpg",
        "caption": "Learning-based quality assessment for HEDP foam experiments.",
        "alt": "Determining HEDP Foams' Quality with Multi-View Deep Learning Classification preview image"
      },
      {
        "id": "cvdl-instabilities",
        "year": 2020,
        ...
        "venue": "arXiv",
        "summary": "A full computer-vision workflow for hydrodynamic instability analysis.",
        ...
        "paperUrl": "https://arxiv.org/abs/2004.03374",
        "image": "assets/papers/generated/cvdl-instabilities.jpg",
        "caption": "A full computer-vision workflow for hydrodynamic instability analysis.",
        "alt": "Complete Deep Computer-Vision Methodology for Investigating Hydrodynamic Instabilities preview image"
      }
    ]
  },
  {
    ...
    "description": "This is an emerging biological thread centered on RNA editing and language-model-based sequence reasoning. Relative to the other projects, it is newer, but it already has the shape of a coherent frontier in computational biology.",
    "bullets": [
      "Language models for RNA editing prediction",
      "Biologically grounded continual fine-tuning",
      "A bridge between LLM methods and molecular biology tasks"
    ],
    "papers": [
      {
        "id": "adar-gpt",
    ...
    "papers": [
      {
        ...
        "venue": "SC Workshops",
        "summary": "Memory-system work for CXL-enabled disaggregated HPC architectures.",
        ...
        "paperUrl": "https://arxiv.org/abs/2308.10714",
        "image": "assets/papers/found-cxl.png",
        "caption": "Memory-system work for CXL-enabled disaggregated HPC architectures.",
        "alt": "CXL Memory as Persistent Memory for Disaggregated HPC: A Practical Approach preview image"
      },
      {
        "id": "nvm-esr",
        "year": 2022,
        ...
        "venue": "FTXS@SC",
        "summary": "Recovery of distributed iterative solvers with non-volatile memory.",
        ...
        "paperUrl": "https://arxiv.org/abs/2204.11584",
        "image": "assets/papers/generated/nvm-esr.jpg",
        "caption": "Recovery of distributed iterative solvers with non-volatile memory.",
        "alt": "Recovery of Distributed Iterative Solvers for Linear Systems Using Non-Volatile RAM preview image"
      },
      {
        "id": "assessing-pmem",
        "year": 2021,
        ...
        "venue": "FTXS@SC",
        "summary": "Persistent-memory use cases for high-performance scientific workloads.",
        ...
        "paperUrl": "https://arxiv.org/abs/2109.02166",
        "image": "assets/papers/generated/assessing-pmem.jpg",
        "caption": "Persistent-memory use cases for high-performance scientific workloads.",
        "alt": "Assessing the Use Cases of Persistent Memory in High-Performance Scientific Computing preview image"
      },
      {
        "id": "distributed-backup-one-round",
        "year": 2020,
        ...
        "venue": "SOSA",
        "summary": "Distributed backup placement as a systems and resilience problem.",
        ...
        "paperUrl": "https://arxiv.org/abs/1908.05700",
        "image": "assets/papers/found-distributed.png",
        "caption": "Distributed backup placement as a systems and resilience problem.",
        "alt": "Distributed Backup Placement in One Round and Its Applications to Maximum Matching Approximation and Self-Stabilization preview image"
      },
      {
        "id": "s2s-compilers",
        "year": 2020,
        ...
        "venue": "International Journal of Parallel Programming",
        "summary": "A systematic analysis of source-to-source compilers for scientific parallelization.",
        ...
        "paperUrl": "https://link.springer.com/article/10.1007/s10766-019-00640-3",
        "image": "assets/papers/generated/s2s-compilers.jpg",
        "caption": "A systematic analysis of source-to-source compilers for scientific parallelization.",
        "alt": "Source-to-Source Parallelization Compilers for Scientific Shared-Memory Multi-Core and Accelerated Multiprocessing: Analysis, Pitfalls, Enhancement and Potential preview image"
      },
      {
        "id": "backus",
        "year": 2019,
        ...
        "venue": "arXiv",
        "summary": "Research software engineering for simulation codes in supercomputing systems.",
        ...
        "paperUrl": "https://arxiv.org/abs/1910.06415",
        "image": "assets/papers/generated/backus.jpg",
        "caption": "Research software engineering for simulation codes in supercomputing systems.",
        "alt": "BACKUS: Comprehensive High-Performance Research Software Engineering Approach for Simulations in Supercomputing Systems preview image"
      }
    ]
  }
];
